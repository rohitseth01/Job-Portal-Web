            ...
            filterCompany.map((company) => (
              <TableRow key={company._id} className="hover:bg-gray-50/40 transition-colors">
                <TableCell className="py-4">
                  {/* Containerized Logo for professional look */}
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-32 p-1 rounded-xl shadow-2xl border-gray-100">
                      <div 
                        ...
                        className="flex items-center gap-3 px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-purple-50 hover:text-[#6A38C2] rounded-lg cursor-pointer transition-all"
                      >
                        <Edit2 className="w-4" />
                        <span>Edit</span>
                      </div>
