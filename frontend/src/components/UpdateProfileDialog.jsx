        ...
        <Dialog open={open}>
            ...
            >
                <DialogHeader>
                    ...
                    <p className="text-sm text-gray-500 font-medium">Refine your professional identity here.</p>
                </DialogHeader>
                ...
                <form onSubmit={submitHandler} className="space-y-5 mt-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <Label htmlFor="phoneNumber" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Phone Number</Label>
                        <Input
                            id="phoneNumber"
                            name="phoneNumber"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <Label htmlFor="bio" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Bio / Headline</Label>
                        <Input
                            id="bio"
                            name="bio"
                            value={input.bio}
                            onChange={changeEventHandler}
                            placeholder={user?.role === 'recruiter' ? "Expert Tech Recruiter" : "Passionate Frontend Developer"}
                            className="rounded-xl border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-purple-100 transition-all font-medium py-6"
                        />
                    </div>
                    ...
                    {user?.role !== "recruiter" && (
                        <>
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="skills" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Technical Skills</Label>
                                <Input
                                    id="skills"
                                    name="skills"
                                    value={input.skills}
                            ...
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="file" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Resume (PDF)</Label>
                                <Input
                                    id="file"
                                    name="file"
                                    type="file"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <Label htmlFor="profilePhoto" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Profile Picture</Label>
                        <Input
                            id="profilePhoto"
                            type="file"
                            onChange={fileChangeHandler}
                    ...
                    <DialogFooter className="pt-4">
                        {loading ? (
                            <Button disabled className="w-full bg-[#6A38C2] rounded-xl font-bold py-7">
                                <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                                Processing Update...
                            </Button>
                        ) : (
                            <Button type="submit" className="w-full bg-[#6A38C2] hover:bg-[#5a2eb0] rounded-xl font-black py-7 text-white tracking-wide transition-all active:scale-95 shadow-xl shadow-purple-100">
                                Apply Changes
                            </Button>
                        )}
                    </DialogFooter>
